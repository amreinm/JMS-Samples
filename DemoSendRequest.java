// SCCSID "@(#) samples/jms/FddSendRequest1.java, jmscc.samples, k000, k000-L090724  1.7 09/04/18 08:03:50"
/*
 * <N_OCO_COPYRIGHT>
 ...
 * <NOC_COPYRIGHT>
 *
 * ******************** specials für München Event, Sep 2013:
 *                    * Reply-To Queue entfernt
 *                    * 2 Properties als Variablen
 */
package demo;
 ...
 * Usage:
 * 
 * DemoSendRequest -i initialContext -c connectionFactory -d destination -p1 prop_value_1 -q prop_value_2
 * 
 * for example:
 * 
 * java demo.DemoSendRequest -i file:/C:/$Data/JNDI-Directory -c jms.WINMQ -d jms.TEST.QL01 -p medium -q blue
 */
public class DemoSendRequest {
  ...
  private static String PropValue1; 
  private static String PropValue2; 
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      TextMessage message = session
          .createTextMessage("This message comes with User Properties size="+ PropValue1 + " , color= "+ PropValue2);
      ...
      message.setStringProperty("Size", PropValue1);
      message.setStringProperty("Color", PropValue2);     
  ...
  private static void printUsage() {
    System.out.println("\nUsage:");
    System.out.println("DemoSendRequest -i initialContext -c connectionFactory -d requestQ -p PropValue1 -q PropValue2");
    return;
  }
